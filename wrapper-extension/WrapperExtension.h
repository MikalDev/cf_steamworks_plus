...
private:
		...
		// SteamNetworkingMessagesSessionRequest_t CCallResult
		CCallResult<WrapperExtension, SteamNetworkingMessagesSessionRequest_t> m_CallbackSessionRequest;
		bool m_bNetworkingMessagesEnabled = false;
